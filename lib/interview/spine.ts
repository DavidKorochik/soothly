...
export const THEMES: Theme[] = [
  ...
  { key: "hardship", chapter: 2, question: "הזמן הכי קשה שעברת. קח/י את הזמן.", desc: "the hardest period they ever went through" },
  ...
  { key: "insight", chapter: 4, question: "תובנה אחת על החיים שהגעת אליה בדרך הקשה.", desc: "one insight about life they reached the hard way" },
  { key: "change", chapter: 4, question: "במה השתנית הכי הרבה בעשור האחרון?", desc: "how they changed most over the past decade" },
